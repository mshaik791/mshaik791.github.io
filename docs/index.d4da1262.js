...
})({"aQ2zq":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "336f7b6ad4da1262";
"use strict";
...
},{}],"5hbo3":[function(require,module,exports) {
...
const texture1 = loader.load((0, _imagesDefault.default).me1);
const texture2 = loader.load((0, _imagesDefault.default).me2);
const texture3 = loader.load((0, _imagesDefault.default).me3);
const texture4 = loader.load((0, _imagesDefault.default).me4);
const texture5 = loader.load((0, _imagesDefault.default).me5);
const texture6 = loader.load((0, _imagesDefault.default).me6);
...
},{"three":"ktPTu","./images":"iJaWS","../shaders/vertex.glsl":"36Lj9","../shaders/fragment.glsl":"i5xNU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"36Lj9":[function(require,module,exports) {
...
},{}],"i5xNU":[function(require,module,exports) {
module.exports = "#define GLSLIFY 1\nuniform sampler2D uTexture;\nuniform float uAlpha;\nuniform vec2 uOffset;\nvarying vec2 vUv;\n\nvec3 rgbShift(sampler2D textureimage, vec2 uv, vec2 offset ){\n    float r = texture2D(textureimage, uv + offset).r;\n    vec2 gb = texture2D(textureimage, uv).gb;\n    return vec3(r, gb);\n}\n\nvoid main(){\n    // vec3 color = texture2D(uTexture, vUv).rgb;\n    vec3 color = rgbShift(uTexture, vUv, uOffset);\n    gl_FragColor = vec4(color, uAlpha);\n}\n";

},{}]},["aQ2zq","5hbo3"], "5hbo3", "parcelRequire2041")

//# sourceMappingURL=index.d4da1262.js.map
